...
class emailController extends Controller
{
	public function sendemail(Request $request){
        ...
        ->select('emailuser_email','emailuser_name')
		...
		'emailldetail_sendby' 			=> $getuseremail->emailuser_email,
		'emailldetail_sendbyname'		=> $getuseremail->emailuser_name,
		...
		$details['fromname'] = $getuseremail->emailuser_name;
		$details['fromemail'] = $getuseremail->emailuser_email;
	...
	public function inboxemaillist(Request $request){
		...
		->where('emailsendto_email','=',$getemail->emailuser_email)
		->where('status_id','=',1)
		->get()->toArray();
		$sortemailids = array();
	...
	public function sentemaillist(Request $request){
		...
		$getinboxlist = DB::table('emaillist')
		->select('*')
		->where('senderemail','=',$getemail->emailuser_email)
	...
	public function emaildetail(Request $request){
		...
		$getsenderdetail = DB::table('emailldetail')
			...
			->where('status_id','=',1)
			->first();
		$getsenderdpicture = DB::table('emailuser')
			->select('emailuser_picture')
			->where('emailuser_email','=',$getsenderdetail->emailldetail_sendby)
			->first();
		if (isset($getsenderdpicture)) {
			$senderpicture = $getsenderdpicture->emailuser_picture;
		}else{
